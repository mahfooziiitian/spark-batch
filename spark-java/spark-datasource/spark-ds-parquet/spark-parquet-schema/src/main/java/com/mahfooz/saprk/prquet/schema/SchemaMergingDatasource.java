...
public class SchemaMergingDatasource {

    public static void main(String[] args) {

        SparkSession spark = SparkSession.builder()
                .master("local[*]")
                .appName("SchemaMergingDatasource")
                .getOrCreate();
        ...
        squaresDF.write().mode(SaveMode.Overwrite).parquet(basePath + "/key=1");
        ...
        cubesDF.write().mode(SaveMode.Append).parquet(basePath + "/key=2");
