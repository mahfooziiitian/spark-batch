...
class SparkSteps @Inject() (
  ...
  @Given(
    "spark format: {string} for table: {string} has data with defaults {string}:"
  )
  def setDataFrame(
      format: String,
      tableOrPath: String,
  ...
  @Given(
    "spark format: {string} for table: {string} has data with defaults {string} as {string}:"
  )
  def setTypeCheckedDataFrame(
      format: String,
      tableOrPath: String,
      defaults: String,
      `class`: String,
  ...
  @Given(
    "spark format: {string} for table: {string} has data with defaults as {string}:"
  )
  def setTypeCheckedDataFrame(
      format: String,
      tableOrPath: String,
  ...
  def setTypeCheckedDataFrameWithoutDefaults(
      format: String,
      tableOrPath: String,
      `class`: String,
      dataTable: DataTable
  ...
  @Then(
    "spark format: {string} for table: {string} wrote data with defaults {string}:"
  )
  def assertDataFrame(
      format: String,
      tableOrPath: String,
  ...
  @Then(
    "spark format: {string} for table: {string} wrote data with defaults {string} as {string}:"
  )
  def assertTypeCheckedDataFrame(
      format: String,
      tableOrPath: String,
      defaults: String,
      `class`: String,
  ...
  @Then(
    "spark format: {string} for table: {string} wrote data with defaults as {string}:"
  )
  def assertTypeCheckedDataFrame(
      format: String,
      tableOrPath: String,
  ...
  def assertTypeCheckedDataFrameWithoutDefaults(
      format: String,
      tableOrPath: String,
      `class`: String,
      dataTable: DataTable
  ...
  private def findClass(`class`: String): Class[_] = {
    ...
    val classNames = dataTypesPackages.map { pack =>
      pack + "." + `class`
    } :+ `class`
    ...
    throw new ClassNotFoundException(
      "Tried classes: " + classNames.mkString(", ")
    )
  }

  private def findNotUsedFields(
      `class`: Class[_],
      dataTable: DataTable
  ): String = {
