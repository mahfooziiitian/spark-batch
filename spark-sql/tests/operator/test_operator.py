...
class TestOperator:
    def test_arithmetic_query_comes_from_source(self: TestOperator, spark: SparkSession) -> None:
        statement = statement_containing("sql/operator/operator.sql", "10 DIV 3 AS int_division")
    ...
    def test_set_operator_query_comes_from_source(self: TestOperator, spark: SparkSession) -> None:
        ...
        statement = statement_containing("sql/operator/operator.sql", "FROM all_products\nEXCEPT")
