...
### :material-animation-play: Interactive Visualization — Layer, Impact & Effort

<div id="viz-optimization-layers" class="ts-viz"></div>

Pick a technique to see which optimization layer it runs in, its typical impact, and how
much effort it takes to enable.
