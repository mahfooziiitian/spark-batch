...
[point-in-interval fixed-length pattern](point-in-interval.md#7-using-fixed-length-interval).
...
[fan-out pitfall](point-in-interval.md#9-using-range-condition-with-additional-join-conditions)
...
!!! tip "Always scope range joins by resource"
    ...
    resource identifier — see [Data Explosion](../../../issues/data-explosion.md) for the general
