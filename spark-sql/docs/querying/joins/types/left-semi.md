...
!!! warning "IN vs LEFT SEMI JOIN"
    ...
    (see the [Left Anti Join](left-anti.md) page), and even plain `IN` can be less efficient than
...
- [Left Anti Join](left-anti.md) — the mirror image: keep only non-matching rows
