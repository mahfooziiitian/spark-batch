...
- [Event Stream Analytics](event-stream-analytics.md) — clickstream processing
- [Gaps & Islands](gaps-islands.md) — consecutive sequence detection
- [Path Analysis](../customer_analytics/path-analysis.md) — user navigation paths
