...
!!! note "Sparse data handling"
    ...
    may reference a non-adjacent period. See [Gap Filling](gap-filling.md).
...
- [Period Comparison](../../sequence/period-comparison.md) — generalised LAG/LEAD comparisons
- [Forecast Features](forecast-features.md) — lag + rolling stats for ML
- [Time Aggregation](time-aggregation.md) — DATE_TRUNC-based grouping
- [Gap Filling](gap-filling.md) — handle missing periods before comparison
