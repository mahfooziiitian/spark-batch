...
- [Interval Analytics](interval-analytics.md) — full interval pattern catalog with performance best practices
...
- [Time Aggregation](time-aggregation.md) — bucketed aggregation patterns
