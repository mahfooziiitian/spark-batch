...
- [Forecast Features](forecast-features.md) — time-series-specific lag and rolling features
- [Rolling Statistics](rolling-statistics.md) — variance, stddev, z-scores
- [RFM Segmentation](../../customer_analytics/rfm-segmentation.md) — recency/frequency/monetary scoring
