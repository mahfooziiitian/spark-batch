...
- [Time Binning](time-binning.md) — convert range joins to equi-joins with hour/day bins (10–100× speedup)
- [Interval Merge](../../sequence/interval-merge.md) — detailed merging of overlapping intervals
- [Sessionization](../../sequence/sessionization.md) — gap-based session detection from events
- [Gaps & Islands](../../sequence/gaps-islands.md) — general gaps-and-islands pattern
- [Utilization Analysis](utilization-analysis.md) — resource busy/idle measurement
- [Queue Analysis](queue-analysis.md) — waiting and processing time intervals
- [Cost Attribution](cost-attribution.md) — extended cost allocation patterns
- [Time Allocation](time-allocation.md) — proportional time distribution
