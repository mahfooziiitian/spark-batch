...
- [ABC Classification](../../customer_analytics/abc-classification.md) — Pareto-based inventory segmentation
- [Seasonality Detection](seasonality-detection.md) — adjust demand for seasonal patterns
- [Trend Detection](trend-detection.md) — spot demand acceleration or decline
- [Capacity Planning](capacity-planning.md) — warehouse space and storage forecasting
