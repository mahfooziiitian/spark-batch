...
if __name__ == "__main__":
    ...
    data = [
        (
            1,
            "<book><title>Effective Java</title><author>Joshua Bloch</author><price>45.00</price></book>",
        ),
        (
            2,
            "<book><title>Clean Code</title><author>Robert C. Martin</author><price>50.00</price></book>",
        ),
    ]
