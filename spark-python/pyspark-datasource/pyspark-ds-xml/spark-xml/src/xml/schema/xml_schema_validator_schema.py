                                        ...
                                        StructField(
                                            ...
                                            StructType(
                                                [
                                                    ...
                                                    StructField(
                                                        "PostalCode", LongType(), True
                                                    ),
                                                    StructField(
                                                        "Region", StringType(), True
                                                    ),
                                                ]
                                            ),
                                            True,
                            ...
                            ArrayType(
                                StructType(
                                    [
                                        ...
                                        StructField(
                                            "RequiredDate", TimestampType(), True
                                        ),
                                        StructField(
                                            "ShipInfo",
                                            StructType(
                                                [
                                                    ...
                                                    StructField(
                                                        "ShipRegion", StringType(), True
                                                    ),
                                                    StructField(
                                                        "ShipVia", LongType(), True
                                                    ),
                                                    StructField(
                                                        "_ShippedDate",
                                                        TimestampType(),
