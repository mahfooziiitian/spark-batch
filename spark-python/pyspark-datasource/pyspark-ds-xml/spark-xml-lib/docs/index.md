...
A comprehensive PySpark project demonstrating XML reading, writing, parsing, validating, and transforming using the [Databricks spark-xml](https://github.com/databricks/spark-xml) library.
...
```
spark-xml/
├── src/spark_xml/        # Source modules (one per feature)
