"""SparkSession factory with sensible defaults for HTML workloads.

This module provides create_spark_session() for library/test usage (no env setup).
For examples that need full env configuration, use pys_html.config.get_spark() instead.
"""
...
def create_spark_session(
    app_name: str = "pys-html",
    master: str | None = None,
    log_level: str = "WARN",
    configs: dict[str, str] | None = None,
) -> SparkSession:
    """Create a SparkSession configured for local HTML processing.
