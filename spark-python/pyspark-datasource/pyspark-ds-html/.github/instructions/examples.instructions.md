...
2. Import from `pys_html` library (not raw pyspark boilerplate)
...
from pys_html import get_spark, print_header, print_schema, print_dataframe, set_log_level
...
Use the `pys_html` library — never duplicate boilerplate:

```python
# Good
from pys_html import get_spark, DATA_HOME, write_json_lines

# Bad — raw boilerplate
from pyspark.sql import SparkSession
import os
os.environ["JAVA_HOME"] = "/usr/lib/jvm/java-17-openjdk-amd64"  # hardcoded, not portable
