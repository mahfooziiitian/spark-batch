...
[project]
name = "pyspark-ds-html"
version = "0.1.0"
description = "PySpark 4 HTML Datasource — tutorials, demos, and reusable library"
...
- **beautifulsoup4 + lxml/html5lib** — required for HTML parsing/scraping (no native Spark HTML source).
...
- `pythonpath = ["src"]` ensures `pys_html` is importable in tests.

## Project Layout

```
pyspark-ds-html/
├── src/pys_html/     # Installable library package
