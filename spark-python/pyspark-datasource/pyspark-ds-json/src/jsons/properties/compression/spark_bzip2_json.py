...
if __name__ == '__main__':
    ...
    gzip_json_file = f"{data_home}/FileData/Json/properties/compression/bzip2/json_bzip2"

    # Write the DataFrame to a Gzip compressed JSON file
    df.write.mode("overwrite").json(gzip_json_file, compression="bzip2")
