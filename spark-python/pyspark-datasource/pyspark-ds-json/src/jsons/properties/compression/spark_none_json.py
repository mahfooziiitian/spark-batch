...
if __name__ == '__main__':
    ...
    lz4_json_file = f"{data_home}/FileData/Json/properties/compression/none/json_none"

    # Write the DataFrame to a Gzip compressed JSON file
    df.write.mode("overwrite").json(lz4_json_file, compression="none")
