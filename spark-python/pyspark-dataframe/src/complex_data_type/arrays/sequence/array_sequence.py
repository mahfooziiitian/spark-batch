...
from pyspark.sql.functions import lit, expr, sequence
...
if __name__ == '__main__':
    ...
    df_appended = (df.withColumn("sequence_array", functions.sequence(lit(1),
                                                                      lit(8),
                                                                      lit(1))))
    ...
    df_appended = df_appended.withColumn("generated_dates",
                                         sequence(expr("CAST('{}' AS DATE)".format(start_date)),
