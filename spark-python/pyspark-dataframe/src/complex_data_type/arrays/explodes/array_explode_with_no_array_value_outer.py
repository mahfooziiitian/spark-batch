...
if __name__ == "__main__":
    ...
    spark_app = SparkSession.builder.appName('array_explode_with_no_array_value').getOrCreate()
    ...
    # for the above data
    schema = StructType(
        [StructField("Student_category", IntegerType()), StructField("Student_full_name", ArrayType(StringType()))])
