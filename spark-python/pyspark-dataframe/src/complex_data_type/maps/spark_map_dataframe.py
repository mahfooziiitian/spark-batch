...
from pyspark.sql.functions import col, map_keys, map_values, map_concat
from pyspark.sql.types import StringType, MapType, Row, StructType, ArrayType
...
if __name__ == '__main__':
    ...
    arrayStructureSchema = (
        ...
        .add("addresses", ArrayType(StructType()
                                    .add("city", StringType())
    ...
    mapTypeDF.select(col("name"), map_concat(col("properties"), col("secondProp"))).show(truncate=False)
